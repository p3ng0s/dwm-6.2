...
dwm fork for p3ng0s ^^ maintained by me over the years.

## Installed patches:
 - [dwm-gesture-6.4.diff](https://gist.github.com/p4p1/bd6bea1dc3fe5136e540274e6ddfa36a)
 ...
 - [dwm-deck-6.2.diff](https://dwm.suckless.org/patches/deck/dwm-deck-6.2.diff)
 - [dwm-fibonacci-6.2.diff](https://dwm.suckless.org/patches/fibonacci/dwm-fibonacci-6.2.diff)

## Screenshots
<p>
  <img src="/img/center_master.png", title="demo"/>
  <img src="/img/fib.png", title="demo"/>
  <img src="/img/tile.png", title="demo"/>
</p>
